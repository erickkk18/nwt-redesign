  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Layered SVG skyline placeholder — sunset teal sky over Houston buildings */}
        <SkylineArt />
      </div>
      ...
      <div style={{
        ...
        background: 'linear-gradient(180deg, transparent 0%, rgba(10,58,71,0.55) 70%, rgba(10,58,71,0.85) 100%)',
        pointerEvents: 'none',
      }}/>
      ...
      <div className="container-wide" style={{
        ...
        <div style={{ maxWidth: 980 }}>
          <div className="eyebrow" style={{ color: 'rgba(246,242,234,0.7)', marginBottom: 28 }}>
            <span style={{ display: 'inline-block', width: 24, height: 1, background: 'currentColor', verticalAlign: 'middle', marginRight: 12 }}/>
            Est. 2007 &middot; Houston, Texas
          </div>
          <h1 className="display" style={{
            ...
            Client focused.<br/>
            <span className="display-italic" style={{ color: 'var(--teal-100)' }}>Creative</span> solutions.
          </h1>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 48, flexWrap: 'wrap' }}>
            <p style={{
              ...
              A nimble law firm with a modern approach.
            </p>
            <div style={{ display: 'flex', gap: 12 }}>
              <a href="#approach" className="btn btn-light">
                Our Approach
              </a>
...
// Stylized Houston skyline — layered, atmospheric
function SkylineArt() {
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      <div style={{
        ...
        background: `
          radial-gradient(ellipse 80% 50% at 50% 100%, rgba(199,112,74,0.15) 0%, transparent 60%),
          linear-gradient(180deg, #0a3a47 0%, #14617a 45%, #2a8198 75%, #c7704a 100%)
        `,
      }}/>
      ...
      <div style={{
        position: 'absolute', inset: 0,
        background: `
          radial-gradient(ellipse 60% 20% at 30% 30%, rgba(246,242,234,0.06) 0%, transparent 60%),
          radial-gradient(ellipse 40% 15% at 70% 50%, rgba(246,242,234,0.04) 0%, transparent 60%)
        `,
      }}/>

      {/* Skyline silhouette — back layer */}
      <svg viewBox="0 0 1920 600" preserveAspectRatio="xMidYEnd slice" style={{
      ...
      {/* Skyline silhouette — front layer (taller buildings) */}
      <svg viewBox="0 0 1920 600" preserveAspectRatio="xMidYEnd slice" style={{
        ...
        {/* Foreground crane (referencing original photo) */}
